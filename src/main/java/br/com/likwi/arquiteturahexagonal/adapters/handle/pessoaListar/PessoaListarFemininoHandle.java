...
@Service("F")
public class PessoaListarFemininoHandle implements PessoaListarServicePort {

    private final PessoaJpaRepository pessoaJPARepository;
    private final ModelMapper moodelMapper;

    public PessoaListarFemininoHandle(ModelMapper modelMapper, PessoaJpaRepository pessoaJPARepository) {
    ...
    public List<PessoaDomain> listar(String tipo, String nome, PageManual pageManual) {
        ...
        return this.pessoaJPARepository.findFemale(nome,pageable)
                .stream()
